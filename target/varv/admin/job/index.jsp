            ...
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <div class="breadcrumbs-area clearfix">
                        <h4 class="page-title pull-left">Jobb-vy</h4>
                        <ul class="breadcrumbs pull-left">
                            <li>Jobb /</li>
                            <li><span>Jobb-vy</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Lagg till nytt jobb</span></a>
                        </div>
                    </div>
                </div>
