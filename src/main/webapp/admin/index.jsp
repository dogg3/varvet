...
<head>
    ...
    <title>Ramsovarvet</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/png" href="assets/images/icon/favicon-boat.png">
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="/varv/admin/boat/engine.html">Motor-databas</a></li>
                                    <li><a href="/varv/admin/boat/customerBoats.html">Kundbatar</a></li>
                                    <li><a href="/varv/admin/boat/boatVariantEngine.html">Kundbats-motorer</a></li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="/varv/admin/job/jobTask.html">Job-Arbets-uppgift</a></li>
                                    <li><a href="/varv/admin/job/jobPart.html">Job-delar</a></li>
                                    <li><a href="/varv/admin/job/taskDescriptionPart.html">Arbets-delar</a></li>
                                </ul>
                            </li>
                            <li>
